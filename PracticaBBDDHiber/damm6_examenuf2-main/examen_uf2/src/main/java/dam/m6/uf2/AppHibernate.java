...
public class AppHibernate{
    ...
    public static void main(String[] args) {
        ...
        LlibreHibernate hibernate = new LlibreHibernate();

        int opcion;

        do {
            System.out.println("\n--- MENÚ LLIBRES (Hibernate) ---");
            ...
            switch (opcion) {
                case 1:
                    ...
                    hibernate.insertar(new Llibre(title, author));
                    System.out.println("Llibre afegit.");
                    break;

                case 2:
                    List<Llibre> llibres = hibernate.getAll();
                    if (llibres.isEmpty()) {
                ...
                case 3:
                    ...
                    in.nextLine();
                    Llibre l = hibernate.getById(searchId);
                    if (l != null) {
                ...
                case 4:
                    ...
                    in.nextLine();
                    Llibre llibreToUpdate = hibernate.getById(updateId);
                    if (llibreToUpdate == null) {
                        System.out.println("Llibre no trobat.");
                        break;
                    }
                    ...
                    if (!newTitle.isBlank()) {
                        llibreToUpdate.setTitle(newTitle);
                ...
                case 6:
                    ...
                    List<Llibre> llibresByAuthor = hibernate.getByAuthor(searchAuthor);
